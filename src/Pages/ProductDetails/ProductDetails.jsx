...
const ProductDetails = () => {
    ...
    return (
        <div className="lg:mt-12">
            <SectionTitle heading={`Get Details ` + name} subheading={`Detail Description of ` + name} ></SectionTitle>
            <div className="card lg:card-side bg-base-100 border border-orange-100 items-center gap-6 rounded-none lg:pt-12">
